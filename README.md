...
Сделано по **Sprint 5** (`v0.5.0`): каркас + планировщик (тихие часы, снуз), M0 адаптация + астма-чек Макса, геймификация (стрики 🚶/👃/🧠, XP, уровни, ачивки), M3 груминг, M5 тренинг/трюфели, **M4 здоровье** — прививки/обработки/вет по графику, обработка от клещей после Дуная, журнал веса с трендом. Бот деплоится и шлёт пуши по расписанию.
...
- ✅ **Sprint 1–5** — адаптация+астма, геймификация, груминг, тренинг/трюфели, здоровье+вес (сделано).
