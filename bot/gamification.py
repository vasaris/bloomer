...
XP_PER_EVENT: dict[str, int] = {
    ...
    "health": 10,
    "soc": 25,
    "trip": 20,   # спокойный выезд на тур (Sprint 6)
}
...
ACHIEVEMENTS: dict[str, tuple[str, str]] = {
    ...
    "health_baseline": ("🩺", "Здоровяк — всё по здоровью по графику"),
    "social": ("🐕‍🦺", "Социальный — базовая городская социализация закрыта"),
    "traveler": ("🚗", "Путешественник — первый спокойный выезд на тур"),
}
